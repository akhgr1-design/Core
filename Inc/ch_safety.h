 ...
 */
 ...
 // Modbus Sensor IDs (based on your actual sensor mapping)
#define MODBUS_SENSOR_RETURN_WATER_TEMP   1  // Register 1 - Sensor A0 - Return water temperature
#define MODBUS_SENSOR_SUPPLY_WATER_TEMP   2  // Register 2 - Sensor A1 - Supply water temperature  
#define MODBUS_SENSOR_AMBIENT_TEMP        3  // Register 3 - Sensor A2 - Ambient temperature
#define MODBUS_SENSOR_CONDENSER_TEMP      4  // Register 4 - Sensor A3 - Condenser temperature

// Compressor temperatures (use available sensors as placeholders)
#define MODBUS_SENSOR_COMP_TEMP_1         1  // Use A0 (Return water) as compressor temp reference
#define MODBUS_SENSOR_COMP_TEMP_2         2  // Use A1 (Supply water) as compressor temp reference
#define MODBUS_SENSOR_COMP_TEMP_3         3  // Use A2 (Ambient) as compressor temp reference
#define MODBUS_SENSOR_COMP_TEMP_4         4  // Use A3 (Condenser) as compressor temp reference

// Oil temperatures (use available sensors as placeholders)
#define MODBUS_SENSOR_OIL_TEMP_1          1  // Use A0 (Return water) as oil temp reference
#define MODBUS_SENSOR_OIL_TEMP_2          2  // Use A1 (Supply water) as oil temp reference

// Pressure sensors (use available sensors as placeholders)
#define MODBUS_SENSOR_HIGH_PRESSURE       3  // Use A2 (Ambient) as high pressure reference
#define MODBUS_SENSOR_LOW_PRESSURE        4  // Use A3 (Condenser) as low pressure reference

// GPIO Input Definitions (map to your actual GPIO inputs)
#define GPIO_INPUT_EMERGENCY_STOP         0
#define GPIO_INPUT_WATER_FLOW             1
#define GPIO_INPUT_PHASE_MONITOR          2
#define GPIO_INPUT_COMP_OVERLOAD_1        3

// GPIO Relay Definitions (map to your actual relay outputs)
#define GPIO_RELAY_COMPRESSOR_1           0
#define GPIO_RELAY_CONDENSER_1            8

// HMI VP Register Definitions
#define VP_SAFETY_SYSTEM_STATE           0x1000
#define VP_SAFETY_ACTIVE_ALARMS          0x1001
#define VP_SAFETY_FAULT_COUNT            0x1002
#define VP_SAFETY_RETURN_WATER_TEMP      0x1003
#define VP_SAFETY_SUPPLY_WATER_TEMP      0x1004
#define VP_SAFETY_AMBIENT_TEMP           0x1005
#define VP_SAFETY_CONDENSER_TEMP         0x1006
#define VP_SAFETY_HIGH_PRESSURE          0x1007
#define VP_SAFETY_LOW_PRESSURE           0x1008
#define VP_SAFETY_DIGITAL_INPUTS         0x1009
